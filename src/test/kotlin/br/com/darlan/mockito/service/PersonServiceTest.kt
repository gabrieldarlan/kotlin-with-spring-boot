package br.com.darlan.mockito.service
...
import br.com.darlan.unittests.mapper.mocks.MockPerson
...
internal class PersonServiceTest {
    ...
    @Test
    fun `create with null person`() {
        val exception: Exception = assertThrows(
            RequiredObjectIsNullException::class.java
        ) { service.create(null) }

        val expectedMessage = "It is not allowed to persit a null object"
        val actualdMessage = exception.message
